/*
L.TileLayer.ZoomableImage displays tile image with Leaflet library

Based on Leaflet.Zoomify (https://github.com/turban/Leaflet.Zoomify)
 */

L.TileLayer.ZoomableImage = L.TileLayer.extend({
	options: {
...
L.tileLayer.zoomableImage = function (url, options) {
	return new L.TileLayer.ZoomableImage(url, options);
};
